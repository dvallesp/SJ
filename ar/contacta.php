...
<html lang="ar" dir="auto">
  <head>
    ...
    <title>اتصال | Josep Sanjuan</title>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">رواق <span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="cast.html">صب</a></li>
                    <li><a href="circ.html">الدوائر</a></li>
                    <li><a href="esctrof.html">المنحوتات والجوائز</a></li>
                    <li><a href="fus.html">الصمامات</a></li>
                    <li><a href="fusmel.html">الصمامات معدني</a></li>
                    <li><a href="lap.html">شواهد القبور</a></li>
                    <li><a href="sagfam.html">العائلة المقدسة</a></li>
                    <li><a href="chorrar.html">الرملي أعمال</a></li> 
                    <li><a href="ttm.html">أعمال سائل الإعلام المختلطة</a></li>
                    <li><a href="vifo.html">زجاج المصقول</a></li>
                    <li><a href="vptt.html">الزجاج المسطح تقنية تيفاني</a></li>       
                    <li><a href="vsc.html">الزجاج المنفوخ وعاء</a></li>            
                  </ul>
                </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="contacta.php">اتصال</a></li>
              </ul>
            </div><!-- /.navbar-collapse -->
          </div><!-- /.container-fluid -->
        </nav>
  ...
  if (isset($_POST["submit"])) {
    ...
    if (!$_POST['message']) {
      $errMessage = 'Pالرجاء إدخال رسالة';
    }
    //Check if simple anti-bot test is correct
    if ($human !== 5) {
      $errHuman = 'هل يتم تمرير مرشح لمكافحة البريد المزعج. حاول مرة اخرى.';
    }
// If there are no errors, send the email
if (!$errName && !$errEmail && !$errMessage && !$errHuman) {
  if (mail ($to, $subject, $body, $from)) {
    $result='<div class="alert alert-success">شكر! سوف أرد في أقرب وقت ممكن.</div>';
  } else {
    $result='<div class="alert alert-danger">آسف، لم يكن هناك خطأ أثناء إرسال الرسالة. حاول مرة اخرى.اكتب لي</div>';
  }
}
  }
?>
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="form"><!--formulario-->
            <form class="form-horizontal" role="form" method="post" action="contacta.php">
              <div class="form-group">
                  <label for="name" class="col-sm-2 control-label">اسم</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control" id="name" name="name" placeholder="الاسم الأول والأخير" value="<?php echo htmlspecialchars($_POST['name']); ?>">
              ...
              <div class="form-group">
                  <label for="message" class="col-sm-2 control-label">رسالة</label>
                  <div class="col-sm-10">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" id="human" name="human" placeholder="ردك">
                      <?php echo "<p class='text-danger'>$errHuman</p>";?>
                  </div>
              </div>
              <div class="form-group">
                  <div class="col-sm-10 col-sm-offset-2">
                      <input id="submit" name="submit" type="submit" value="إرسال" class="btn btn-primary">
                  </div>
              </div>
              <div class="form-group">
                  <div class="col-sm-10 col-sm-offset-2">
