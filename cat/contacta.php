...
<html lang="ca">
  <head>
    ...
    <title>Contacta | Josep Sanjuan</title>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Galeries <span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="cast.html">Casting</a></li>
                    <li><a href="circ.html">Cercles</a></li>
                    <li><a href="esctrof.html">Escultures i trofeus</a></li>
                    <li><a href="fus.html">Fusing</a></li>
                    <li><a href="fusmel.html">Fusing metalitzats</a></li>
                    <li><a href="lap.html">Làpides</a></li>
                    <li><a href="sagfam.html">Sagrada Família</a></li>
                    <li><a href="chorrar.html">Treballs amb raig de sorra</a></li> 
                    <li><a href="ttm.html">Treballs de tècnica mixta</a></li>
                    <li><a href="vifo.html">Vidre flotat</a></li>
                    <li><a href="vptt.html">Vidre pla i tècnica Tifanny</a></li>       
                    <li><a href="vsc.html">Vidre bufat i gresol</a></li>            
                  </ul>
                </li>
  ...
  if (isset($_POST["submit"])) {
    ...
    if (!$_POST['name']) {
      $errName = 'Per favor, introdueix el teu nom.';
    }
    
    // Check if email has been entered and is valid
    if (!$_POST['email'] || !filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
      $errEmail = 'Per favor, introdueix una direcció e-mail vàlida';
    }
    
    //Check if message has been entered
    if (!$_POST['message']) {
      $errMessage = 'Per favor, introdueix un missatge';
    }
    //Check if simple anti-bot test is correct
    if ($human !== 5) {
      $errHuman = 'No has superat el filtre anti-spam. Per favor, torna a intentar-ho';
    }
// If there are no errors, send the email
if (!$errName && !$errEmail && !$errMessage && !$errHuman) {
  if (mail ($to, $subject, $body, $from)) {
    $result='<div class="alert alert-success">Gràcies! Et respondré a la major brevetat.</div>';
  } else {
    $result='<div class="alert alert-danger">Disculpa, ha hagut algun error. Per favor, torna a intentar-ho.</div>';
  }
}
  }
?>
